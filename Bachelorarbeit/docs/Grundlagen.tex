...
\subsection{Die Simulationsumgebung - COMSOL Multiphysics\textsuperscript{\textregistered}\label{sub:comsol}}

COMSOL Multiphysics\textsuperscript{\textregistered} wird seit 1998 vertrieben\footcite[Vgl.][S. 2]{COMSOL2020}. Das Programm stellt eine frei definierbare Physikumgebung für gekoppelte Simulationen zur Verfügung.
